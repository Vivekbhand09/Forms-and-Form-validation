...
const phoneValidator = /^\+?\d{1,4}?[-.\s]?\(?\d{1,3}?\)?[-.\s]?\d{3}[-.\s]?\d{4}$/;
...
class FormComponent extends React.Component {
  ...
  autoComplete="off"
/><br></br>
<button class="pass_button" onClick={() => this.setState(prevState => ({ showPassword: !prevState.showPassword }))}>
